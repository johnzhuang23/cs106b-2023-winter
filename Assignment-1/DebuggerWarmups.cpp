 ...
 *
 * Q1:
 * It once came to pass that
 * the writer Jorge Luis Borges
 * was polishing the mirrors on the James Webb Space Telescope
 * when, suddenly,
 * zz
 * saved the Palace of Darius the Great
 * from overzealous ice cream enthusiasts
